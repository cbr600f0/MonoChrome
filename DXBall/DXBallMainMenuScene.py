...
class DXBallMainMenuScene(SceneManager.Scene):
    ...
    def __init__(self):
        ...
        self.startBtn = Button(">", None, None, [2, 255, 149], [110, 90, 73], 70, 480, None, 70)
        self.optionsBtn = Button(">", None, None, [2, 255, 149], [110, 90, 73], 70, 530, None, 70)
        self.quitBtn = Button(">", None, None, [2, 255, 149], [110, 90, 73], 70, 580, None, 70)
