...
class BubbleShooterScene(SceneManager.Scene):
    ...
    def update(self, deltaTime):
        ...
        currentUsedRadiusForSomething = (50, angle)
        print(currentUsedRadiusForSomething)
        ...
        if self.Player['shoot'] == True:
            self.Player['xPos'] += ((self.mousePositionXOnClick - self.Player['xClickPos']) / self.Velocity)
            self.Player['yPos'] += ((self.mousePositionYOnClick - self.Player['yClickPos']) / self.Velocity)
